...
from pytorch3d.renderer.mesh.textures import TexturesAtlas, TexturesUV, TexturesVertex, Textures, TexturesBase

from pytorch3d.renderer.mesh.textures import interpolate_face_attributes
...
def interpolate_texture_map(fragments, meshes,texture_maps = None) -> torch.Tensor:
    ...
    """
    if not isinstance(meshes.textures, TexturesBase):
